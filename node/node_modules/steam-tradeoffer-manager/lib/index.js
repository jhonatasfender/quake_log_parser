...
const LeastUsedCache = require('@doctormckay/leastused-cache');
...
function TradeOfferManager(options) {
	...
	if (options.globalAssetCache) {
		global._steamTradeOfferManagerAssetCache = global._steamTradeOfferManagerAssetCache || new LeastUsedCache(500, 120000);
		this._assetCache = global._steamTradeOfferManagerAssetCache;
	} else {
		this._assetCache = new LeastUsedCache(500, 120000);
	}
